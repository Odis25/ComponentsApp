...
namespace ComponentApp.WPF.Models
{
    internal class Sample : ViewModel
    {
        #region Поля
        ...
        {
            get => _cH3;
            set { Set(ref _cH3, value); OnPropertyChanged(nameof(Summ)); }
        }
        public double C2H6
        {
            get => _c2H6;
        ...
        public double Summ => O2 + N2 + CO2 + H + He + C2H6 + C3H8 + IC4H10 + NC4H10 + IC5H12 + NC5H12 + C6H14;
